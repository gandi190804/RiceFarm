...
<head>
    ...
    <!-- Page Title  -->
    <title>RiceFarm | Pengeluaran</title>
                        ...
                        <div class="contact-form-style-one">
                            ...
                            <form action='/save-Financials' method='POST'>
                                ...
                                <div class="row" style="margin-bottom: 5px;">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control" id="pengeluaran" name="pengeluaran"
                                                placeholder="Jumlah Pengeluaran" type="number" required>
                                            <span class="alert-error"></span>
                                        </div>
                                    </div>
                                </div>
