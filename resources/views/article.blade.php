...
<body>
    ...
    <!-- Start Breadcrumb -->
    <div class="breadcrumb-area text-center shadow dark bg-fixed text-light" style="background-image: url(assets/img/pertanian.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li>
                                <h1>Artikel Seputar Pertanian</h1>
                            </li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row">
                <div class="blog-content col-xl-10 offset-xl-1 col-md-12">
                    <div class="blog-item-box">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="assets/img/artikel/{{ $ar ->gambar}}" alt="Thumb" style="width: 1500px;"></a>
                            </div>
                            <br><br><br>
                            <div class=" info">
                                <h2 class="title">
