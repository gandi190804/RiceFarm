...
<body>
    ...
    <div5 class="navigation-circle text-light text-center banner-style-three-area zoom-effect overflow-hidden">
                    ...
                    <div class="col-tact-style-one">
                        <div class="contact-form-style-one">
                            <h1 class="judul"
                                ...
                                Masuk</h1>
                            <form action="{{route('signin')}}" method="POST" class="contact-form contact-form">
                                @csrf
                                ...
                                <div class="row" style="margin-bottom: 5px; margin-top: 30px;">
                                    <div class="col-lg-12">
                                        <p style="color: black">
                                            Tidak punya akun?
                                            <a href="/register">
                                                <span style="color: #000">Daftar</span>
                                            </a>
                                        </p>
                                    </div>
                                </div>
